...
const pleasingMessages = [
    "আনিকা পচা!",
    "আনিকা ত বিয়ে করে চলেই যাবে, থাকবো তো আমি!",
    "আনিকা ঝগড়াইট্টা 😄",
    "আনিকাকে ত ডাস্টবিন থেকে পাইসো 😊",
    "অহিনে ক্লিক করলে চা বানিয়ে খাওয়াবো🌟",
    "আনিকাতে ক্লিক করে লাভ নেই 😄",
    "অহিনে টিপ দেও 🎉",
    "আনিকা বলদ💆‍♀️",
    "অহিনে ক্লিক না করলে চলতেই থাকবে",
    "অহিন ভালো",
    "অহিনে ক্লিক করো 🎉"
];
...
function updateAttemptCounter() {
    ...
    if (noClickCount === 1) {
        message = " আনিকাকে ক্লিক কেন করসো? 🥺";
    } else if (noClickCount === 3) {
        message = `আনিকাতে ${noClickCount} বার ক্লিক! 😢`;
    } else if (noClickCount === 5) {
        message = `${noClickCount} বার আনিকাতে ক্লিক করেও লাভ হলো না! 💔`;
    } else if (noClickCount === 10) {
        message = `${noClickCount} বার ক্লিক! অহিনে ক্লিক করো!  😭`;
    } else if (noClickCount > 10) {
        message = `${noClickCount} বার! চলতেই থাকবে অহিনে ক্লিক করা পর্যন্ত ❤️`;
    }
